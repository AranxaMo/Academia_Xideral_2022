...
<body>
	<div id="wrapper" style="background-color: #9DEDB6; color:#024713">
		<div id="header">
	...
	<div class="container my-5 col-lg-4">
		...
		<p>
			...
			<a href="${pageContext.request.contextPath}/customer/list" class="btn btn-link btn-lg">Back to List</a>
		</p>
